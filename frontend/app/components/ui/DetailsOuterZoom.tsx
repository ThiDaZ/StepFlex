...
import SliderZoomOuter from "@/app/components/ProductCard/SliderZoomOuter";
import toast from "react-hot-toast";


export default function DetailsOuterZoom(product: SingleProduct) {
    ...
    const onSubmit = async () => {
        ...
        const response = await fetch(`http://localhost:8080/backend/AddToCart?id=${id}&qty=${qty}`, {
            method: "GET",
            credentials: "include"
        })
                                ...
                                <div className="tf-product-info-list other-image-zoom">
                                    ...
                                    <div className="variant-picker-item">
                                        ...
                                        <form className="variant-picker-values">
                                            ...
                                            <React.Fragment key={product.size.id}>
                                                <input
                                                    type="radio"
                                                    name="size1"
                                                    id={product.size.id.toString()}
                                                    readOnly
                                                    checked={currentSize == product.size}
                                                />
                                                <label
                                                    onClick={() => setCurrentSize(product.size)}
                                                    className="style-text"
                                                    htmlFor={product.size.id.toString()}
                                                    data-value={product.size.id}
                                                >
                                    ...
                                    <div className="tf-product-info-quantity">
                                        ...
                                        {/*<Quantity setQuantity={(value: { value: number }) => setQuantity(value.value)}/>*/}
